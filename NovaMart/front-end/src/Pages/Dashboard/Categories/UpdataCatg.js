...
export default function UpdateCatg() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        await Axios.get(`/${cat}/${id}`).then((res) =>
          ...
          <div className="grid gap-2">
            <div className="flex items-center justify-center flex-col">
              <label>
                ...
                <div className="flex w-28 h-9 px-2 flex-col bg-blue-500 rounded-full shadow text-white text-xs font-semibold leading-4 mt-2 items-center justify-center cursor-pointer focus:outline-none">
                  Choose File
                </div>
              </label>
              {fileName && (
                <div className="text-center text-gray-900 text-sm mt-3">
